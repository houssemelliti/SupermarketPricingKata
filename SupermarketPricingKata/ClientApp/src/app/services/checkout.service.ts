...
import { Checkout, Product, DiscountRule } from '../models/models';
 ...
 export class CheckoutService {
   ...
   /**
     * Gets the list of measurment units through HTTP
     * 
     * @param observe set whether or not to return the data Observable as the body, response or events. defaults to returning the body.
     * @param reportProgress flag to report request and response progress.
     */
   public getMeasurmentUnits(observe?: 'body', reportProgress?: boolean): Observable<any>;
   public getMeasurmentUnits(observe?: 'response', reportProgress?: boolean): Observable<HttpResponse<any>>;
   public getMeasurmentUnits(observe?: 'events', reportProgress?: boolean): Observable<HttpEvent<any>>;
   public getMeasurmentUnits(observe: any = 'body', reportProgress: boolean = false): Observable<any> {
     ...
     return this.httpClient.request<any>('get', `${this.basePath}/measurmentUnits`,
       {
         withCredentials: this.configuration.withCredentials,
         headers: headers,
         observe: observe,
